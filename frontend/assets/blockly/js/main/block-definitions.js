...
function defineBlocks() {
  Blockly.defineBlocksWithJsonArray([
    ...
    { type: "ir_sen", message0: "IR Sensor %1 %2", args0: [{ type: "field_image", src: "./assets/img/Chips_Chips_Show.png", width: 15, height: 15, alt: "", name: "IMG" }, { type: "field_label", name: "PORTS", text: "" }], style: "control_blocks", output: "Boolean", extensions: ["digital_style", "ir_sen_image_click"] },
    {
      type: "max",
      message0: "Max",
  ...
  Blockly.Extensions.register('ir_sen_image_click', function () {
    const f = this.getField('IMG'); if (!f) return;
    f.setOnClickHandler(() => openSensorModal('irsen', this));
  });
